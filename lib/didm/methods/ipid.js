...
class Ipid {
    ...
    _assureDidIpid.set(this, {
      ...
      value: async () => {
        if (!_classPrivateFieldGet(this, _didIpid)) {
          _classPrivateFieldSet(this, _didIpid, await (0, _didIpid2.default)(_classPrivateFieldGet(this, _ipfs)));
        }
      }
    });
  ...
  async create(params, operations) {
    const masterKeyPair = await (0, _humanCryptoKeys.generateKeyPair)('rsa');
    await _classPrivateFieldGet(this, _assureDidIpid).call(this);
    const didDocument = await _classPrivateFieldGet(this, _didIpid).create(masterKeyPair.privateKey, document => {
