...
var _ipid = _interopRequireDefault(require("./methods/ipid/ipid"));

var _hyper = _interopRequireDefault(require("./methods/hyper/hyper"));
...
const createDidm = (ipfs, apiMultiAddr, wsMultiAddr, Hyperdrive) => {
  const methods = {
    ...
    hyper: (0, _hyper.default)(Hyperdrive)
  };
